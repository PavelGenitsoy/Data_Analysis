...
def parse_rss(link_main):
    ...
    path_to_file = 'C:\\Users\\Lenovo\\PycharmProjects\\Data_Analysis\\Lab1\\release_var\\all_feed.txt'
        ...
        for _, val in reversed(list(enumerate(link_of_source.entries))):
            ...
            if not grep(path_to_file, val.link):
                try:
                    ...
                    if flag:
                        print('From RSS-feed: ' + link_main + 'Date of publication: ' + val.published + '\n' + 'Title: '
                              + val.title + '\n' + 'Link: ' + val.link + '\n' + 'Summary: ' + summary_upd + '\n\n\n\n',
                              file=f)
                    else:
                        print('From RSS-feed: ' + link_main + 'Date of publication: ' + val.published + '\n' + 'Title: '
                    ...
                    counter += 1
                    print(f'{link_main[x_left:x_right:1]} --> added new info({counter}): \n{val.title}\n{val.link}\n\n')
...
if __name__ == '__main__':
    with open('C:\\Users\\Lenovo\\PycharmProjects\\Data_Analysis\\Lab1\\release_var\\link.txt', mode='r',
